...
- If a capture flow has a submission path but depends on an environment-configured endpoint, do not call it unwired. Report "Capture endpoint needs production verification" with certainty needs_verification and tell the user to confirm the production env var or owned endpoint.
